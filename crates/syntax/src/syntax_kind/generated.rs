...
pub enum SyntaxKind {
    ...
    BEHAVIOUR_ATTRIBUTE = 144u16,
    BIN_ELEMENT = 202u16,
    BINARY = 201u16,
    BINARY_COMPREHENSION = 211u16,
    BINARY_OP_EXPR = 193u16,
    BIT_SIZE_EXPR = 203u16,
    BIT_TYPE_LIST = 204u16,
    BIT_TYPE_UNIT = 209u16,
    BLOCK_EXPR = 199u16,
    ANON_BNOT = 100u16,
    ANON_BOR = 106u16,
    ANON_BSL = 108u16,
    ...
    COMMENT = 128u16,
    ANON_COMPILE = 43u16,
    COMPILE_OPTIONS_ATTRIBUTE = 150u16,
    CONCATABLES = 281u16,
    COND_MATCH_EXPR = 192u16,
    CR_CLAUSE = 241u16,
    ANON_DASH = 2u16,
    ...
    DEPRECATED_ATTRIBUTE = 152u16,
    DEPRECATED_FA = 157u16,
    DEPRECATED_FAS = 156u16,
    DEPRECATED_MODULE = 155u16,
    DEPRECATED_WILDCARD = 53u16,
    DEPRECATION_DESC = 158u16,
    ANON_DIV = 102u16,
    ANON_DOT = 7u16,
    ANON_DOT_DOT = 71u16,
    DOTDOTDOT = 72u16,
    ...
    ANON_EXPORT = 33u16,
    EXPORT_ATTRIBUTE = 145u16,
    ANON_EXPORT_TYPE = 41u16,
    EXPORT_TYPE_ATTRIBUTE = 149u16,
    EXPR_ARGS = 277u16,
    EXTERNAL_FUN = 245u16,
    FA = 148u16,
    ANON_FEATURE = 49u16,
    FEATURE_ATTRIBUTE = 153u16,
    FIELD_EXPR = 233u16,
    FIELD_TYPE = 234u16,
    ANON_FILE = 45u16,
    FILE_ATTRIBUTE = 151u16,
    FLOAT = 124u16,
    ANON_FUN = 70u16,
    FUN_CLAUSE = 251u16,
    FUN_DECL = 175u16,
    ...
    LC_EXPRS = 213u16,
    LIST = 200u16,
    LIST_COMPREHENSION = 210u16,
    ANON_LPAREN = 5u16,
    ANON_LT = 117u16,
    ANON_LT_DASH = 88u16,
    ANON_LT_EQ = 89u16,
    ANON_LT_LT = 81u16,
    MACRO_CALL_ARGS = 273u16,
    MACRO_CALL_EXPR = 272u16,
    MACRO_EXPR = 276u16,
    MACRO_LHS = 270u16,
    MACRO_STRING = 275u16,
    MAP_COMPREHENSION = 212u16,
    MAP_EXPR = 220u16,
    MAP_EXPR_UPDATE = 219u16,
    MAP_FIELD = 222u16,
    MAP_GENERATOR = 217u16,
    MATCH_EXPR = 191u16,
    ANON_MAYBE = 97u16,
    MAYBE_EXPR = 261u16,
    MODULE = 172u16,
    ANON_MODULE = 27u16,
    MODULE_ATTRIBUTE = 143u16,
    MULTI_STRING = 160u16,
    ANON_NOT = 101u16,
    ANON_OF = 93u16,
    OPAQUE = 164u16,
    ...
    OPTIONAL_CALLBACKS_ATTRIBUTE = 147u16,
    ANON_OR = 110u16,
    ANON_ORELSE = 77u16,
    PAREN_EXPR = 198u16,
    PIPE = 181u16,
    ...
    ANON_RBRACK = 36u16,
    ANON_RECEIVE = 94u16,
    RECEIVE_AFTER = 243u16,
    RECEIVE_EXPR = 242u16,
    ANON_RECORD = 59u16,
    RECORD_DECL = 167u16,
    RECORD_EXPR = 227u16,
    RECORD_FIELD = 232u16,
    RECORD_FIELD_EXPR = 225u16,
    RECORD_FIELD_NAME = 229u16,
    RECORD_INDEX_EXPR = 224u16,
    RECORD_NAME = 228u16,
    RECORD_UPDATE_EXPR = 226u16,
    ANON_REM = 103u16,
    REMOTE = 196u16,
    REMOTE_MODULE = 197u16,
    REPLACEMENT_CR_CLAUSES = 265u16,
    REPLACEMENT_EXPR_GUARD = 268u16,
    REPLACEMENT_FUNCTION_CLAUSES = 264u16,
    REPLACEMENT_GUARD_AND = 267u16,
    REPLACEMENT_GUARD_OR = 266u16,
    REPLACEMENT_PARENS = 269u16,
    ANON_RPAREN = 6u16,
    ANON_RRACE = 52u16,
    ANON_SEMI = 65u16,
    ANON_SLASH = 83u16,
    ...
    TYPE_NAME = 166u16,
    TYPE_SIG = 177u16,
    UNARY_OP_EXPR = 194u16,
    ANON_UNDEF = 10u16,
    ANON_UNIT = 85u16,
    VAR = 122u16,
    VAR_ARGS = 278u16,
    ANON_WHEN = 68u16,
    WILD_ATTRIBUTE = 173u16,
    ANON_XOR = 111u16,
    WHITESPACE = 289u16,
    ERROR = u16::MAX,
}
