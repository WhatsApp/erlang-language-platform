...
pub enum SyntaxKind {
    ...
    BIN_ELEMENT = 200u16,
    BINARY = 199u16,
    BINARY_COMPREHENSION = 209u16,
    BINARY_OP_EXPR = 191u16,
    BIT_SIZE_EXPR = 201u16,
    BIT_TYPE_LIST = 202u16,
    BIT_TYPE_UNIT = 207u16,
    BLOCK_EXPR = 197u16,
    ANON_BNOT = 100u16,
    ANON_BOR = 106u16,
    ANON_BSL = 108u16,
    ...
    LC_EXPRS = 211u16,
    LIST = 198u16,
    LIST_COMPREHENSION = 208u16,
    ANON_LPAREN = 5u16,
    ANON_LT = 117u16,
    ANON_LT_DASH = 88u16,
    ANON_LT_EQ = 89u16,
    ANON_LT_LT = 81u16,
    MACRO_CALL_ARGS = 270u16,
    MACRO_CALL_EXPR = 269u16,
    MACRO_EXPR = 273u16,
    MACRO_LHS = 267u16,
    MACRO_STRING = 272u16,
    MAP_COMPREHENSION = 210u16,
    MAP_EXPR = 218u16,
    MAP_EXPR_UPDATE = 217u16,
    MAP_FIELD = 220u16,
    MAP_GENERATOR = 215u16,
    MATCH_EXPR = 189u16,
    ANON_MAYBE = 97u16,
    MAYBE_EXPR = 259u16,
    MODULE = 171u16,
    ...
    ANON_RBRACK = 36u16,
    ANON_RECEIVE = 94u16,
    RECEIVE_AFTER = 241u16,
    RECEIVE_EXPR = 240u16,
    ANON_RECORD = 59u16,
    RECORD_DECL = 166u16,
    RECORD_EXPR = 225u16,
    RECORD_FIELD = 230u16,
    RECORD_FIELD_EXPR = 223u16,
    RECORD_FIELD_NAME = 227u16,
    RECORD_INDEX_EXPR = 222u16,
    RECORD_NAME = 226u16,
    RECORD_UPDATE_EXPR = 224u16,
    ANON_REM = 103u16,
    REMOTE = 194u16,
    REMOTE_MODULE = 195u16,
    REPLACEMENT_CR_CLAUSES = 263u16,
    REPLACEMENT_FUNCTION_CLAUSES = 262u16,
    REPLACEMENT_GUARD_AND = 265u16,
    REPLACEMENT_GUARD_OR = 264u16,
    REPLACEMENT_PARENS = 266u16,
    ANON_RPAREN = 6u16,
    ANON_RRACE = 52u16,
    ANON_SEMI = 65u16,
    ANON_SLASH = 83u16,
