...
pub enum SyntaxKind {
    ...
    BEHAVIOUR_ATTRIBUTE = 147u16,
    BIN_ELEMENT = 205u16,
    BINARY = 204u16,
    BINARY_COMPREHENSION = 214u16,
    BINARY_OP_EXPR = 196u16,
    BIT_SIZE_EXPR = 206u16,
    BIT_TYPE_LIST = 207u16,
    BIT_TYPE_UNIT = 212u16,
    BLOCK_EXPR = 202u16,
    ANON_BNOT = 100u16,
    ANON_BOR = 106u16,
    ANON_BSL = 108u16,
    ...
    COMMENT = 131u16,
    ANON_COMPILE = 43u16,
    COMPILE_OPTIONS_ATTRIBUTE = 153u16,
    CONCATABLES = 284u16,
    COND_MATCH_EXPR = 195u16,
    CR_CLAUSE = 244u16,
    ANON_DASH = 2u16,
    ...
    DEPRECATED_ATTRIBUTE = 155u16,
    DEPRECATED_FA = 160u16,
    DEPRECATED_FAS = 159u16,
    DEPRECATED_MODULE = 158u16,
    DEPRECATED_WILDCARD = 53u16,
    DEPRECATION_DESC = 161u16,
    ANON_DIV = 102u16,
    ANON_DOT = 7u16,
    ANON_DOT_DOT = 71u16,
    DOTDOTDOT = 72u16,
    ...
    ANON_EXPORT = 33u16,
    EXPORT_ATTRIBUTE = 148u16,
    ANON_EXPORT_TYPE = 41u16,
    EXPORT_TYPE_ATTRIBUTE = 152u16,
    EXPR_ARGS = 280u16,
    EXTERNAL_FUN = 248u16,
    FA = 151u16,
    ANON_FEATURE = 49u16,
    FEATURE_ATTRIBUTE = 156u16,
    FIELD_EXPR = 236u16,
    FIELD_TYPE = 237u16,
    ANON_FILE = 45u16,
    FILE_ATTRIBUTE = 154u16,
    FLOAT = 124u16,
    ANON_FUN = 70u16,
    FUN_CLAUSE = 254u16,
    FUN_DECL = 178u16,
    ...
    LC_EXPRS = 216u16,
    LIST = 203u16,
    LIST_COMPREHENSION = 213u16,
    ANON_LPAREN = 5u16,
    ANON_LT = 117u16,
    ANON_LT_DASH = 88u16,
    ANON_LT_EQ = 89u16,
    ANON_LT_LT = 81u16,
    MACRO_CALL_ARGS = 276u16,
    MACRO_CALL_EXPR = 275u16,
    MACRO_EXPR = 279u16,
    MACRO_LHS = 273u16,
    MACRO_STRING = 278u16,
    MAP_COMPREHENSION = 215u16,
    MAP_EXPR = 223u16,
    MAP_EXPR_UPDATE = 222u16,
    MAP_FIELD = 225u16,
    MAP_GENERATOR = 220u16,
    MATCH_EXPR = 194u16,
    ANON_MAYBE = 97u16,
    MAYBE_EXPR = 264u16,
    MODULE = 175u16,
    ANON_MODULE = 27u16,
    MODULE_ATTRIBUTE = 146u16,
    MULTI_STRING = 163u16,
    ANON_NOT = 101u16,
    ANON_OF = 93u16,
    OPAQUE = 167u16,
    ...
    OPTIONAL_CALLBACKS_ATTRIBUTE = 150u16,
    ANON_OR = 110u16,
    ANON_ORELSE = 77u16,
    PAREN_EXPR = 201u16,
    PIPE = 184u16,
    ...
    ANON_RBRACK = 36u16,
    ANON_RECEIVE = 94u16,
    RECEIVE_AFTER = 246u16,
    RECEIVE_EXPR = 245u16,
    ANON_RECORD = 59u16,
    RECORD_DECL = 170u16,
    RECORD_EXPR = 230u16,
    RECORD_FIELD = 235u16,
    RECORD_FIELD_EXPR = 228u16,
    RECORD_FIELD_NAME = 232u16,
    RECORD_INDEX_EXPR = 227u16,
    RECORD_NAME = 231u16,
    RECORD_UPDATE_EXPR = 229u16,
    ANON_REM = 103u16,
    REMOTE = 199u16,
    REMOTE_MODULE = 200u16,
    REPLACEMENT_CR_CLAUSES = 268u16,
    REPLACEMENT_EXPR_GUARD = 271u16,
    REPLACEMENT_FUNCTION_CLAUSES = 267u16,
    REPLACEMENT_GUARD_AND = 270u16,
    REPLACEMENT_GUARD_OR = 269u16,
    REPLACEMENT_PARENS = 272u16,
    ANON_RPAREN = 6u16,
    ANON_RRACE = 52u16,
    ANON_SEMI = 65u16,
    ANON_SLASH = 83u16,
    ...
    TYPE_NAME = 169u16,
    TYPE_SIG = 180u16,
    UNARY_OP_EXPR = 197u16,
    ANON_UNDEF = 10u16,
    ANON_UNIT = 85u16,
    VAR = 122u16,
    VAR_ARGS = 281u16,
    ANON_WHEN = 68u16,
    WILD_ATTRIBUTE = 176u16,
    ANON_XOR = 111u16,
    WHITESPACE = 292u16,
    ERROR = u16::MAX,
}
