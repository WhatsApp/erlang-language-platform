...
pub(crate) fn builtin_dynamic_call_patterns() -> Vec<DynamicCallPatternInput> {
    let patterns = [
        ...
        // meck - dynamic call patterns (Module + Function + Args/Arity/FunArity)
        "meck:called(Module, Function, Args)",
        "meck:called(Module, Function, Args, _)",
        "meck:capture(_, Module, Function, Args, _)",
        "meck:capture(_, Module, Function, Args, _, _)",
        "meck:num_calls(Module, Function, Args)",
        "meck:num_calls(Module, Function, Args, _)",
        "meck:wait(Module, Function, Args, _)",
        "meck:wait(_, Module, Function, Args, _)",
        "meck:wait(_, Module, Function, Args, _, _)",
        // meck - functions accepting both atom and list forms
        "meck:delete(Module, Function, Arity)",
        "meck:delete([Module], Function, Arity)",
        "meck:delete(Module, Function, Arity, _)",
        "meck:delete([Module], Function, Arity, _)",
        "meck:expect(Module, Function, FunArity)",
        "meck:expect([Module], Function, FunArity)",
        "meck:expect(Module, Function, Arity, _)",
        "meck:expect([Module], Function, Arity, _)",
        "meck:loop(Module, Function, Arity, _)",
        "meck:loop([Module], Function, Arity, _)",
        "meck:sequence(Module, Function, Arity, _)",
        "meck:sequence([Module], Function, Arity, _)",
        // meck - module-arg-only patterns (no Function argument)
