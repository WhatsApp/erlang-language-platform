...
config_data! {
  struct ConfigData {
      ...
      newIfdef_enable: bool = json! { false },
...
impl Config {
    ...
    pub fn set_new_ifdef(&mut self, value: bool) {
        self.data.newIfdef_enable = value;
    }

    pub fn new_ifdef(&self) -> bool {
        self.data.newIfdef_enable
    }
...
mod tests {
    ...
    fn generate_package_json_config() {
        ...
        expect![[r#"
            ...
            "elp.newIfdef.enable": {
              "default": false,
              "markdownDescription": "Enable new ifdef/ifndef condition evaluation (experimental).\nWhen enabled, preprocessor conditions are evaluated and inactive forms are skipped.",
              "type": "boolean"
            },
