...
buck2 build fbcode//whatsapp/elp/test_projects/codegen_test:example_service_types_erl

# Build the application (automatically runs code generation)
buck2 build fbcode//whatsapp/elp/test_projects/codegen_test:codegen_test_app

# Run tests
buck2 test fbcode//whatsapp/elp/test_projects/codegen_test:codegen_test_SUITE
